...
const CustomConfirmModal = ({ isOpen, onClose, onConfirm, title, message, confirmText = "Delete", cancelText = "Cancel" }) => {
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="px-4 py-3 flex justify-between items-center border-b bg-red-50">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-md font-bold text-red-600">{title || "Confirm Delete"}</h2>
            </div>
