...
const MobileFrameSelector = ({ onFrameChange }) => {
  ...
  const frames = [
    { id: "iphone15", name: "iPhone 15 Pro Max", brand: "Apple", icon: <FaApple className="text-xl" /> },
    { id: "redmi", name: "Redmi Note 13 Pro", brand: "Xiaomi", icon: <SiXiaomi className="text-xl" /> },
    { id: "xiaomi", name: "Xiaomi 14 Ultra", brand: "Xiaomi", icon: <SiXiaomi className="text-xl" /> },
    { id: "oneplus", name: "OnePlus 12", brand: "OnePlus", icon: <span className="text-sm font-bold">1+</span> },
    { id: "pixel", name: "Pixel 8 Pro", brand: "Google", icon: <span className="text-sm font-bold">G</span> }
  ];
  ...
  return (
    <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-50 hidden lg:block">
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-2 border border-gray-200">
        <h3 className="text-[10px] font-semibold text-gray-400 text-center mb-1">PHONE MODELS</h3>
